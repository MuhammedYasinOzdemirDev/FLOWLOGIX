...
- Kullanıcının “olur/onaylıyorum” cevabı yalnız agent'ın hemen önce açıkça saydığı eylemleri kapsar; komşu taska, yeni kaynak koduna, yeni dış hizmete veya sonraki güne taşınmaz.
- Harici hesap bağlama, repository secret'ı oluşturma, bulut kaynağı açma ve ücret doğurma ihtimali olan ayarlar; önce kapsam, veri/secret akışı, ücretsiz sınır ve kapatma yöntemi anlatıldıktan sonra task-bazlı açık onay gerektirir.
...
- Dış hizmet veya deployment taskında “ücretsiz” ifadesi pazarlama adı olarak kabul edilmez; güncel kota, otomatik ücretlendirme davranışı, kart/abonelik gereksinimi, veri kalıcılığı ve silme/geri dönüş adımı doğrulanır.
